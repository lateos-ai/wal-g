...
//
//	mockgen -source=internal/uploader.go -destination=./testtools/mocks/uploader.go
//
...
func (mr *MockUploaderMockRecorder) ChangeDirectory(relativePath any) *gomock.Call {
...
func (mr *MockUploaderMockRecorder) PushStream(ctx, stream any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) PushStreamToDestination(ctx, stream, dstPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) Upload(ctx, path, content any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) UploadExactFile(ctx, file any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) UploadFile(ctx, file any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) UploadJSON(ctx, path, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
