...
func init() {
	binlogListCmd.PersistentFlags().StringVar(&listSince, "since", "",
		"show binlogs modified since this time (e.g., '2h', '30m', '2023-01-01T10:00:00Z', 'LATEST')")
	binlogListCmd.PersistentFlags().StringVar(&listUntil, "until", "",
		"show binlogs modified until this time (e.g., '1h', '2023-01-01T12:00:00Z')")
