...
// UploadOplogArchive provides a mock function with given fields: ctx, stream, firstTS, lastTS
func (_m *Uploader) UploadOplogArchive(ctx context.Context, stream io.Reader, firstTS models.Timestamp, lastTS models.Timestamp) error {
	ret := _m.Called(ctx, stream, firstTS, lastTS)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, io.Reader, models.Timestamp, models.Timestamp) error); ok {
		r0 = rf(ctx, stream, firstTS, lastTS)
	} else {
		r0 = ret.Error(0)
	}
