...
// are sanitized for security. The Makefile exports (and recipes prefix)
// CGO_CFLAGS/CGO_LDFLAGS pointing at the tree populated by link_libsodium.sh
// so that the actual include/library paths are honored.
