...
// All C integration goes through walg_init.c (which includes <sodium.h>)
// and walg_config.h (generated by link_libsodium.sh). We avoid
// #include <sodium.h> in the Go preamble to work around cgo DWARF
